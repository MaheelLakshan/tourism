      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
          <div className="flex items-center">
            ...
            <p className="ml-3 text-sm text-white">Visit the top highlights</p>
          </div>
          ...
          <div className="flex items-center">
            ...
            <p className="ml-3 text-sm text-white">Remarkable experiences</p>
          </div>
          ...
          <div className="flex items-center">
            ...
            <p className="ml-3 text-sm text-white">Reserve stays</p>
          </div>
        </div>
      </div>
    </div>
